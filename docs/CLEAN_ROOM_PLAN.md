...
| Risk | Handling |
|---|---|
| Accidental inclusion of an internal identifier | Automated scan over the working tree *and* full Git history before publication; results recorded in `PRE_PUBLICATION_REVIEW.md` |
